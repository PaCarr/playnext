...
function SearchPage() {
  ...
  return (
    <div className="max-w-6xl mx-auto px-8 py-10 page-fade">
      ...
      {!hasSearched && (
        <>
          <p className="text-white text-xs uppercase tracking-widest mb-4">Top Rated Games</p>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 opacity-70 mb-10">
          ...
          <p className="text-white text-xs uppercase tracking-widest mb-4">Recently Released</p>
